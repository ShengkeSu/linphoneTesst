...
import main.compatibility.CompatibilityScaleGestureDetector;
import main.compatibility.CompatibilityScaleGestureListener;
public class CallVideoFragment extends android.app.Fragment implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, CompatibilityScaleGestureListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mVideoView = (SurfaceView) view.findViewById(R.id.surfaceView);
        mCaptureView = (SurfaceView) view.findViewById(R.id.surfaceView2);
...
//                }
        ...
        mCaptureView.setOnTouchListener(new View.OnTouchListener() {
            @Override
...
//                androidVideoWindowImpl.setOpenGLESDisplay(G);
